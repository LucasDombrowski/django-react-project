...
INSTALLED_APPS = [
    ...
    'django_bridge',
    'django_bridge_project.apps.DjangoBridgeProjectConfig',
    # any other apps
]
...
MIDDLEWARE = [
    ...
    "django_bridge_project.middleware.auth_redirect_middleware.AuthenticatedUserRedirectMiddleware",
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    "django_bridge.middleware.DjangoBridgeMiddleware",
]

ROOT_URLCONF = "django_bridge_project.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            BASE_DIR / "django_bridge_project" / "templates",
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "django_bridge_project.wsgi.application"
